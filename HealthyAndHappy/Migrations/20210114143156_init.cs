        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Larder_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "ProductsForLarder",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    LarderId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsForLarder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductsForLarder_Larder_LarderId",
                        column: x => x.LarderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsForRecipe", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductsForRecipe_Recipe_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsForLarder_LarderId",
                table: "ProductsForLarder",
                column: "LarderId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsForRecipe_RecipeId",
                table: "ProductsForRecipe",
                column: "RecipeId");
